...
- When relevant, the agent should explicitly reference code examples from [Bevy](https://github.com/bevyengine/bevy) and/or [SpacetimeDB](https://github.com/clockworklabs/spacetimedb). You may also reference [Flecs](https://github.com/SanderMertens/flecs-engine).
