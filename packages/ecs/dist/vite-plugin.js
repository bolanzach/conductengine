...
const createTransformer = require("./compiler.cjs").default;
/**
 ...
 */
export function conductVitePlugin(options = {}) {
    let config;
    let compilerOptions;
    ...
    return {
        ...
        transform(code, id) {
            ...
            try {
                ...
                const sourceFile = ts.createSourceFile(id, code, compilerOptions.target ?? ts.ScriptTarget.ES2022, true, id.endsWith(".tsx") ? ts.ScriptKind.TSX : ts.ScriptKind.TS);
                ...
                const compilerHost = {
                    getSourceFile: (fileName) => {
                        ...
                        if (existsSync(fileName)) {
                            ...
                            return ts.createSourceFile(fileName, content, compilerOptions.target ?? ts.ScriptTarget.ES2022, true);
                        }
                        return undefined;
                    },
